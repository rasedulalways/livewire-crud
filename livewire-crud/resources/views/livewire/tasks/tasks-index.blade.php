...
<div class="w-4/12 bg-slate-200 rounded-md mt-2">
    <div class="mt-6 px-6">
        <div>
            <h1 class="text-2xl text-center font-semibold">Welcome, <span class="text-indigo-500">{{ Auth::user()->name }}</span></h1>
        ...
        <div class="mt-4">
            ...
            <form wire:submit="save">
                ...
                <div class="mb-3 flex justify-between">
                    ...
                    <button type="button" wire:click="refresh" class="flex py-2 px-4 bg-slate-400 hover:bg-slate-500 text-white rounded-md">
                        Refresh
                    </button>
                </div>
            </form>
